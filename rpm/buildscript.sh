...
# Get opencpu sources
wget https://github.com/jeroenooms/opencpu-server/archive/v1.5.3.tar.gz -O opencpu-server-1.5.3.tar.gz
tar xzvf opencpu-server-1.5.3.tar.gz opencpu-server-1.5.3/rpm/opencpu.spec --strip-components 2
mv -f opencpu-server-1.5.3.tar.gz ~/rpmbuild/SOURCES/
